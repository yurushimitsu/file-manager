...
@section('title', 'File Manager | Login')
            ...
            <div class="flex flex-row">
                <div class="w-full md:w-1/2 items-center p-10">
                    <div class="flex flex-col h-full items-center justify-center">
                        ...
                        <a href="{{ route('auth.google.redirect') }}" class="relative mb-5 w-full text-gray-900 cursor-pointer hover:bg-blue-300 bg-white shadow-lg font-medium rounded-lg text-sm py-3 text-center focus:ring-2 focus:outline-none focus:ring-primary-300">
                        ...
                        <form class="w-full" action="{{ route('loginEmail') }}" method="POST">
                            ...
                            <div class="w-full">
                                <div class="relative z-0 w-full mb-5 group">
                                    <input type="email" name="email" id="email" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-blue-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder="" required />
                                ...
                                <div class="relative z-0 w-full mb-5 group">
                                    <input type="password" name="password" id="password" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-blue-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder="" required />
                                    ...
                                    <button type="button" tabindex="-1" class="absolute right-0 top-1/2 transform -translate-y-1/2 text-sm text-gray-500 px-2 focus:outline-none" onclick="togglePasswordVisibility('password', this)">
                                ...
                                <div class="flex items-center justify-between mb-3">
                                    <div class="flex items-start">
                                        ...
                                        <input id="remember" name="remember" aria-describedby="remember" type="checkbox" class="w-4 h-4 border border-gray-300 rounded bg-gray-50 focus:ring-1 focus:ring-blue-300">
                                        </div>
                                        <div class="ml-3 text-sm">
                                        <label for="remember" class="text-blue-400">Remember me</label>
                                        </div>
                                    </div>
                                    <a href="https://accounts.google.com/signin/recovery" target="_blank" class="text-sm text-red-400 hover:underline">Forgot password?</a>
                                </div>
                            </div>
                            @if ($errors->any())
                                @foreach ($errors->all() as $error)
                                    <div class="flex items-center p-3 mb-3 text-sm text-yellow-800 rounded-lg bg-yellow-50" role="alert">
                ...
                <div class="w-1/2 md:block hidden justify-center">
                    <div class="flex flex-col h-full items-center justify-center">
