...
@section('title', 'File Manager | Trash')
            ...
            <div class="p-1">
                <div id="drop-zone" class="relative m-5 p-8 bg-[#E8F8FF] rounded-xl min-h-150">
                    ...
                    <div class="flex justify-between">
                        ...
                        <div>
                            <button id="emptyTrash" onclick="deleteFile(null, null, true)" type="button" class="text-white font-bold bg-blue-400 w-25 hover:bg-blue-500 cursor-pointer inline-flex items-center justify-center focus:outline-none focus:ring-2 focus:ring-blue-500 rounded-full text-sm py-2 lg:me-5 text-center">
