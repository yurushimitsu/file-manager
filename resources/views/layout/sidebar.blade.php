<div class="fixed top-20 ms-3 lg:hidden bg-white">
    <ul class="space-y-2 pt-3 font-medium">
        ...
        <li>
            <a href="{{ Route('media') }}" class="flex items-center justify-center p-2 text-gray-900 rounded-xl hover:bg-[#5BD0F4] hover:text-white {{ (Route::is('media')) ? 'bg-[#5BD0F4] text-white' : '' }} focus:outline-none focus:ring-2 focus:ring-gray-200 group">
        ...
        <li>
            <a href="{{ Route('others') }}" class="flex items-center justify-center p-2 text-gray-900 rounded-xl hover:bg-[#5BD0F4] hover:text-white {{ (Route::is('others')) ? 'bg-[#5BD0F4] text-white' : '' }} focus:outline-none focus:ring-2 focus:ring-gray-200 group">
